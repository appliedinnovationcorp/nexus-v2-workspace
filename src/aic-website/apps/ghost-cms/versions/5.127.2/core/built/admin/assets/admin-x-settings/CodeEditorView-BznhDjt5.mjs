import { b as ce, p as Nn, g as z, f as wt, cg as qn, d as Tt, ch as _n, o as Hn, j as N, ci as Vn, l as zn, R as Un, z as $n, n as Gn, H as Kn, m as Jn } from "./index-BcAsZR_N.mjs";
import { q as d, v as Ot, w as It, x as Ce, y as Pt, S as Re, F as de, E as p, z as te, g as et, b as $e, A as tt, B as _e, C as we, G as jn, H as Qn, J as Yn, K as w, M as X, O as Wt, Q as Ge, R as Ft, U as Zn, V as ue, W as Nt, X as nt, Y as Xn, Z as er, _ as tr, $ as x, a0 as he, a1 as nr, a2 as B, a3 as rr, a4 as or, a5 as ir, a6 as sr, a7 as lr, a8 as ar, a9 as cr, aa as ur, ab as hr, ac as fr, ad as dr, ae as mr, af as gr, ag as qt, ah as pr, ai as yr, aj as xr, ak as kr, al as br, am as Sr, an as _t, ao as Cr, ap as vr, t as f, aq as Ar } from "./index-o4Q9MNrB.mjs";
const Mr = (t) => {
  let { state: e } = t, r = e.doc.lineAt(e.selection.main.from), n = ot(t.state, r.from);
  return n.line ? Lr(t) : n.block ? Dr(t) : !1;
};
function rt(t, e) {
...
const ae = 50;
function Er(t, { open: e, close: r }, n, o) {
...
function Ht(t, e, r = e.selection.ranges) {
  ...
  if (!n.every((i) => i))
    return null;
  let o = r.map((i, s) => Er(e, n[s], i.from, i.to));
  if (t != 2 && !o.every((i) => i))
...
const Ke = /* @__PURE__ */ tt.define(), Tr = /* @__PURE__ */ tt.define(), Or = /* @__PURE__ */ de.define(), Vt = /* @__PURE__ */ de.define({
  combine(t) {
    return we(t, {
      minDepth: 100,
      newGroupDelay: 500,
...
const zt = /* @__PURE__ */ Re.define({
  ...
  update(t, e) {
    ...
    if (n) {
      let a = e.docChanged ? d.single(Ir(e.changes)) : void 0, c = A.fromTransaction(e, a), u = n.side, h = u == 0 ? t.undone : t.done;
      return c ? h = ve(h, h.length, r.minDepth, c) : h = Gt(h, e.startState.selection), new O(u == 0 ? n.rest : h, u == 0 ? h : n.rest);
    }
    let o = e.annotation(Tr);
...
const Ut = /* @__PURE__ */ Te(0, !1), Je = /* @__PURE__ */ Te(1, !1), Wr = /* @__PURE__ */ Te(0, !0), Fr = /* @__PURE__ */ Te(1, !0);
class A {
  ...
  static fromTransaction(e, r) {
    let n = D;
    for (let o of e.startState.facet(Or)) {
      let i = o(e);
...
class O {
  ...
  addChanges(e, r, n, o, i) {
    ...
    return l && l.changes && !l.changes.empty && e.changes && (!n || zr.test(n)) && (!l.selectionsAfter.length && r - this.prevTime < o.newGroupDelay && o.joinToEvent(i, Nr(l.changes, e.changes)) || // For compose (but not compose.start) events, always join with previous event
  ...
  addSelection(e, r, n, o) {
    ...
    return i.length > 0 && r - this.prevTime < o && n == this.prevUserEvent && n && /^select($|\.)/.test(n) && qr(i[i.length - 1], e) ? this : new O(Gt(this.done, e), this.undone, r, n);
  }
  addMapping(e) {
...
const Ur = [
  ...
  { key: "Mod-u", run: Wr, preventDefault: !0 },
  { key: "Alt-u", mac: "Mod-Shift-u", run: Fr, preventDefault: !0 }
];
function oe(t, e) {
...
const $r = (t) => Qt(t, !S(t)), Gr = (t) => Qt(t, S(t));
function Kr(t, e, r) {
  if (e.type.prop(r))
    return !0;
  let n = e.to - e.from;
...
const Jr = (t) => T(t, (e) => Ie(t.state, e, !S(t))), jr = (t) => T(t, (e) => Ie(t.state, e, S(t)));
function Yt(t, e) {
  return T(t, (r) => {
    if (!r.empty)
      return Oe(r, e);
...
const Qr = (t) => T(t, (e) => _(t, e, !0)), Yr = (t) => T(t, (e) => _(t, e, !1)), Zr = (t) => T(t, (e) => _(t, e, !S(t))), Xr = (t) => T(t, (e) => _(t, e, S(t))), eo = (t) => T(t, (e) => d.cursor(t.lineBlockAt(e.head).from, 1)), to = (t) => T(t, (e) => d.cursor(t.lineBlockAt(e.head).to, -1));
function no(t, e, r) {
...
const ro = ({ state: t, dispatch: e }) => no(t, e);
function E(t, e) {
...
const oo = (t) => sn(t, !S(t)), io = (t) => sn(t, S(t)), so = (t) => E(t, (e) => Ie(t.state, e, !S(t))), lo = (t) => E(t, (e) => Ie(t.state, e, S(t)));
function ln(t, e) {
...
const ft = (t) => un(t, !1), dt = (t) => un(t, !0), ao = (t) => E(t, (e) => _(t, e, !0)), co = (t) => E(t, (e) => _(t, e, !1)), uo = (t) => E(t, (e) => _(t, e, !S(t))), ho = (t) => E(t, (e) => _(t, e, S(t))), fo = (t) => E(t, (e) => d.cursor(t.lineBlockAt(e.head).from)), mo = (t) => E(t, (e) => d.cursor(t.lineBlockAt(e.head).to)), mt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: 0 })), !0), gt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.doc.length })), !0), pt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.selection.main.anchor, head: 0 })), !0), yt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.selection.main.anchor, head: t.doc.length })), !0), go = ({ state: t, dispatch: e }) => (e(t.update({ selection: { anchor: 0, head: t.doc.length }, userEvent: "select" })), !0), po = ({ state: t, dispatch: e }) => {
...
const hn = (t, e) => Pe(t, (r) => {
  ...
  if (!e && r > o.from && r < o.from + 200 && !/[^ \t]/.test(i = o.text.slice(0, r - o.from))) {
    if (i[i.length - 1] == "	")
      return r - 1;
    let l = Wt(i, n.tabSize), a = l % Ge(n) || Ge(n);
  ...
  return n;
}), mn = (t) => dn(t, !1), ko = (t) => dn(t, !0), gn = (t) => Pe(t, (e) => {
...
const vo = ({ state: t, dispatch: e }) => pn(t, e, !1), Ao = ({ state: t, dispatch: e }) => pn(t, e, !0);
function yn(t, e, r) {
  if (t.readOnly)
    return !1;
  let n = [];
...
const Mo = ({ state: t, dispatch: e }) => yn(t, e, !1), Lo = ({ state: t, dispatch: e }) => yn(t, e, !0), Bo = (t) => {
  if (t.state.readOnly)
    return !1;
...
const Eo = /* @__PURE__ */ xn(!1), Ro = /* @__PURE__ */ xn(!0);
function xn(t) {
...
const wo = ({ state: t, dispatch: e }) => {
  ...
  { key: "Ctrl-a", run: eo, shift: fo },
  { key: "Ctrl-e", run: to, shift: mo },
  { key: "Ctrl-d", run: fn },
  { key: "Ctrl-h", run: Qe },
  { key: "Ctrl-k", run: gn },
  ...
  { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: $r, shift: oo, preventDefault: !0 },
  { mac: "Cmd-ArrowLeft", run: Zr, shift: uo, preventDefault: !0 },
  { key: "ArrowRight", run: jt, shift: on, preventDefault: !0 },
  { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: Gr, shift: io, preventDefault: !0 },
  { mac: "Cmd-ArrowRight", run: Xr, shift: ho, preventDefault: !0 },
  ...
  { key: "Home", run: Yr, shift: co, preventDefault: !0 },
  { key: "Mod-Home", run: mt, shift: pt },
  { key: "End", run: Qr, shift: ao, preventDefault: !0 },
  ...
  { key: "Mod-Delete", mac: "Alt-Delete", run: ko },
  { mac: "Mod-Backspace", run: bo },
  { mac: "Mod-Delete", run: gn }
].concat(/* @__PURE__ */ To.map((t) => ({ mac: t.key, run: t.run, shift: t.shift }))), Io = /* @__PURE__ */ [
  { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: Jr, shift: so },
  { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: jr, shift: lo },
  { key: "Alt-ArrowUp", run: vo },
  { key: "Shift-Alt-ArrowUp", run: Mo },
  { key: "Alt-ArrowDown", run: Ao },
  { key: "Shift-Alt-ArrowDown", run: Lo },
  { key: "Escape", run: xo },
  { key: "Mod-Enter", run: Ro },
  { key: "Alt-l", mac: "Ctrl-l", run: po },
  { key: "Mod-i", run: yo, preventDefault: !0 },
  { key: "Mod-[", run: bn },
  { key: "Mod-]", run: kn },
  { key: "Mod-Alt-\\", run: wo },
  { key: "Shift-Mod-k", run: Bo },
  { key: "Shift-Mod-\\", run: ro },
  { key: "Mod-/", run: Mr },
  { key: "Alt-A", run: Br }
].concat(Oo), Po = { key: "Tab", run: kn, shift: bn };
function g() {
  var t = arguments[0];
  ...
  for (; e < arguments.length; e++) Sn(t, arguments[e]);
  return t;
}
function Sn(t, e) {
  if (typeof e == "string")
    ...
    for (var r = 0; r < e.length; r++) Sn(t, e[r]);
  else
  ...
  */
  nextOverlapping() {
    for (; ; ) {
      ...
      let r = tr(e), n = this.bufferStart + this.bufferPos;
      this.bufferPos += er(e);
...
const Me = /* @__PURE__ */ w.define(), kt = /* @__PURE__ */ Re.define({
  create() {
    return !0;
  },
  update(t, e) {
  ...
  if (!e) {
    let r = [Me.of(!0)];
    t.state.field(kt, !1) == null && r.push(w.appendConfig.of([kt, No])), t.dispatch({ effects: r }), e = ue(t, Ye);
  }
  return e && e.dom.querySelector("input").focus(), !0;
}, No = /* @__PURE__ */ p.baseTheme({
...
const $o = /* @__PURE__ */ Nt.fromClass(class {
  ...
  getDeco(t) {
    let e = t.state.facet(_o), { state: r } = t, n = r.selection;
...
class Mn {
  ...
  */
  constructor(e) {
    this.search = e.search, this.caseSensitive = !!e.caseSensitive, this.literal = !!e.literal, this.regexp = !!e.regexp, this.replace = e.replace || "", this.valid = !!this.search && (!this.regexp || Wo(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!e.wholeWord;
  }
  /**
  @internal
  */
...
const fe = /* @__PURE__ */ w.define(), lt = /* @__PURE__ */ w.define(), q = /* @__PURE__ */ Re.define({
  create(t) {
...
class li {
  ...
  keydown(e) {
    rr(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? Ee : De)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), St(this.view));
  }
  update(e) {
...
const wn = /* @__PURE__ */ w.define(), ut = /* @__PURE__ */ w.define(), Tn = /* @__PURE__ */ w.define(), L = /* @__PURE__ */ Re.define({
  create() {
  ...
  update(t, e) {
    ...
    for (let r of e.effects)
      r.is(wn) ? t = U.init(r.value, t.panel, e.state) : r.is(ut) ? t = new U(t.diagnostics, r.value ? Fe.open : null, t.selected) : r.is(Tn) && (t = new U(t.diagnostics, t.panel, r.value));
    return t;
  },
  provide: (t) => [
    nt.from(t, (e) => e.panel),
...
const pi = (t) => {
  ...
  combine(t) {
    return Object.assign({ sources: t.map((e) => e.source) }, we(t.map((e) => e.config), {
      delay: 750,
      markerFilter: null,
      tooltipFilter: null,
      needsRefresh: null
...
var At = function(e) {
  ...
  e.closeBracketsKeymap !== !1 && (n = n.concat(sr)), e.defaultKeymap !== !1 && (n = n.concat(Io)), e.searchKeymap !== !1 && (n = n.concat(si)), e.historyKeymap !== !1 && (n = n.concat(Ur)), e.foldKeymap !== !1 && (n = n.concat(lr)), e.completionKeymap !== !1 && (n = n.concat(ar)), e.lintKeymap !== !1 && (n = n.concat(xi));
  var o = [];
  return e.lineNumbers !== !1 && o.push(cr()), e.highlightActiveLineGutter !== !1 && o.push(ur()), e.highlightSpecialChars !== !1 && o.push(hr()), e.history !== !1 && o.push(Pr()), e.foldGutter !== !1 && o.push(fr()), e.drawSelection !== !1 && o.push(dr()), e.dropCursor !== !1 && o.push(mr()), e.allowMultipleSelections !== !1 && o.push(he.allowMultipleSelections.of(!0)), e.indentOnInput !== !1 && o.push(gr()), e.syntaxHighlighting !== !1 && o.push(qt(Cr, {
    fallback: !0
  })), e.bracketMatching !== !1 && o.push(pr()), e.closeBrackets !== !1 && o.push(yr()), e.autocompletion !== !1 && o.push(xr()), e.rectangularSelection !== !1 && o.push(kr()), r !== !1 && o.push(br()), e.highlightActiveLine !== !1 && o.push(Sr()), e.highlightSelectionMatches !== !1 && o.push(Ho()), e.tabSize && typeof e.tabSize == "number" && o.push(Ft.of(" ".repeat(e.tabSize))), o.concat([_t.of(n.flat())]).filter(Boolean);
};
...
var Ii = p.theme({
  ...
  switch (r && a.unshift(_t.of([Po])), l && (typeof l == "boolean" ? a.unshift(At()) : a.unshift(At(l))), s && a.unshift(Ar(s)), i) {
    case "light":
      a.push(Ii);
      break;
    case "dark":
...
function Ni(t) {
  var {
    ...
    !v.transactions.some((Fn) => Fn.annotation(Rt))) {
  ...
  return s && typeof s == "function" && V.push(p.updateListener.of(s)), V = V.concat(l), Nn(() => {
    if (W && !F) {
      var v = {
        doc: e,
        selection: r,
...
var qi = ["className", "value", "selection", "extensions", "onChange", "onStatistics", "onCreateEditor", "onUpdate", "autoFocus", "theme", "height", "minHeight", "maxHeight", "width", "minWidth", "maxWidth", "basicSetup", "placeholder", "indentWithTab", "editable", "readOnly", "root", "initialState"], Wn = /* @__PURE__ */ wt((t, e) => {
  var {
    className: r,
    value: n = "",
    selection: o,
...
const _i = [
  ...
  const C = zn(), R = Tt(null), [$, G] = ce(100), [H, K] = Un.useState(null), [J, se] = ce({
    crosshairCursor: !1
  }), { setFocusState: P } = $n(), W = (b) => {
    c == null || c(b), P(!0);
  }, j = (b) => {
    u == null || u(b), P(!1);
  };
  ...
  return /* @__PURE__ */ N.jsxs(N.Fragment, { children: [
    ...
    H && /* @__PURE__ */ N.jsxs("div", { className: n === "full" ? "h-full" : "", style: { width: $ }, children: [
      ...
      e && /* @__PURE__ */ N.jsx(Kn, { className: "order-1 !text-grey-700 peer-focus:!text-black", htmlFor: C, useLabelTag: !0, children: e }),
...
//# sourceMappingURL=CodeEditorView-BznhDjt5.mjs.map
